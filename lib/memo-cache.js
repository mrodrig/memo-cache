...
var controller = {
    ...
    cache : {
        ...
        // Return the entire cache to the user
        getAll : function (cacheName) {
            return cacheOps.getAll(cacheName);
        },
...
var cacheOps = {
    ...
    create : function (cacheName, options) {
        if (cacheName) {
            ...
            return {
                ...
                getAll : _.partial(controller.cache.getAll, cacheName),
    ...
    /**
     * Returns the full cache (minus internal metadata)
     * @param cacheName String name of the cache
